...
public class InitResponse {
    @Value("${blog.header.title}")
    private String title;
    @Value("${blog.header.subtitle}")
    private String subtitle;
    @Value("${blog.header.phone}")
    private String phone;
    @Value("${blog.header.email}")
    private String email;
    @Value("${blog.header.copyright}")
    private String copyright;
    @Value("${blog.header.copyrightFrom}")
